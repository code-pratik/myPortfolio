      ...
      <div className="flex flex-col w-full max-w-[700px]">
        ...
        <motion.form variants={fadeIn("up", 0.2)}
          ...
          <button className="btn rounded-full border border-white/50  max-w-[170px] px-8 transition-all duration-300 flex items-center justify-center overflow-hidden group hover:border-accent">
            <span className="group-hover:translate-y-[120%] group-hover:opacity-0 transition-all duration-500">Let&lsquo;s Talk</span><BsArrowRight className="-translate-y-[120%] group-hover:flex group-hover:-translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-300 absolute text-[22px]" />
          </button>
        </motion.form>
      </div>
